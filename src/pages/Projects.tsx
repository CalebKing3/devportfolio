...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      longDescription: 'An advanced analytics platform that helps engineering teams track and improve their development productivity through data-driven insights and metrics.',
    ...
    return (
      ...
      >
        <motion.div
          ...
          className="bg-editor-bg rounded-lg max-w-4xl w-full mx-4 overflow-hidden"
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border-color">
                    <div className="flex items-center space-x-4 text-sm">
                      <span className="flex items-center text-editor-text">
